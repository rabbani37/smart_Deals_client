...
<p className='text-gray-500 hover:underline cursor-pointer'><small>Forgate password ?</small></p>
                        ...
                        <button type="button" className="w-full btn pb-2 border border-gray-300 rounded flex items-center justify-center gap-2 hover:bg-gray-50 hover:ring-1 hover:ring-purple-400">
